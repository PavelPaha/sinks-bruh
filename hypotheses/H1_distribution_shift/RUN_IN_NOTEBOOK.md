...
- `hypotheses/H1_distribution_shift/data/` — сырые `.jsonl.gz`
- `hypotheses/H1_distribution_shift/plots/` — метрики + графики
- `hypotheses/H1_distribution_shift/final.md` — авто-текст (под статью)

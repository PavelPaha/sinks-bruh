...
- `hypotheses/H4_localization/data/` — сырые `.jsonl.gz`
- `hypotheses/H4_localization/plots/` — метрики + графики
- `hypotheses/H4_localization/final.md` — авто-текст (под статью)
